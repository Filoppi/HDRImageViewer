...
//-Fix GUID and CLSID
//-Do shader
DEFINE_GUID(GUID_FixBT2100SDREncodePixelShader, 0xfddf597e, 0x98d4, 0x4aac, 0x83, 0x49, 0x6f, 0xb8, 0x76, 0x67, 0xdc, 0xb5);
DEFINE_GUID(CLSID_CustomFixBT2100SDREncodeEffect, 0x376c22b8, 0xe6c3, 0x41e7, 0xb1, 0xc1, 0xfb, 0x5f, 0x7e, 0xc9, 0xee, 0x49);
...
class FixBT2100SDREncodeEffect : public ID2D1EffectImpl, public ID2D1DrawTransform
{
public:
    // Declare effect registration methods.
    static HRESULT Register(_In_ ID2D1Factory1* pFactory);

    static HRESULT __stdcall CreateFixBT2100SDREncodeImpl(_Outptr_ IUnknown** ppEffectImpl);
